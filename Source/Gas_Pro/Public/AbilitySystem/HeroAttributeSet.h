 ...
 */
UCLASS()
class GAS_PRO_API UHeroAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
public:
	UHeroAttributeSet();
	...
	ATTRIBUTE_ACCESSORS(UHeroAttributeSet, Resilience);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_Vigor, Category = "Primary Attributes")
	FGameplayAttributeData Vigor;
	ATTRIBUTE_ACCESSORS(UHeroAttributeSet, Vigor);
	...
	ATTRIBUTE_ACCESSORS(UHeroAttributeSet, HealthRegeneration);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_ManaRegeneration, Category = "Secondary Attributes")
	FGameplayAttributeData ManaRegeneration;
	ATTRIBUTE_ACCESSORS(UHeroAttributeSet, ManaRegeneration);
	...
	ATTRIBUTE_ACCESSORS(UHeroAttributeSet, IncomingDamage);
